...
export function EditAppLayout(props: EditAppLayoutProps) {
	...
	const handleMenuItemClick = (e: MenuItemOrButtonEvent) => {
		...
		// TODO: Remove...
		if (!['exit', 'save'].includes(action)) alert('Implement: View XML, diff, history & rollback');
	};
	return (
		<Layout
			{...props}
